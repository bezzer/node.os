/**
 * Created by yeliex, modified by bezzer
 */
...
(function() {
  const init = (function() {
    ...
    let isWechat =
      ...
      navigator.userAgent &&
      navigator.userAgent.match(/MicroMessenger/g);
    let isElectron =
      typeof navigator === 'object' &&
      navigator.userAgent &&
      navigator.userAgent.match(/Electron/g);
    ...
    that.isBrowser = (function() {
      return (
        platform === 'browser' || platform === 'nw' || isElectron || isWechat
      );
    })();
    ...
    that.os = () => OS;
    that.platform = () =>
      isWechat ? 'wechat' : isElectron ? 'Electron' : platform;
    return that;
  })();
